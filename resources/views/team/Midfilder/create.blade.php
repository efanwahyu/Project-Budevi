                        ...
                        <div class="row">
                          <div class="col-lg-6">
                            <div class="form-group">
                              ...
                              <input type="text" id="passing" name="passing" class="form-control form-control-alternative" placeholder="Jumalah Passing" value="{{ old('passing')}}">
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group">
                              <label class="form-control-label" for="crossing">Crossing</label>
                              <input type="text" id="crossing" name="crossing" class="form-control form-control-alternative" placeholder="Jumlah Crossing" value="{{ old('crossing')}}">
                            </div>
                          </div>
                        </div>
                      </div>
