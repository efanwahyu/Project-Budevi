        ...
        <div class="row align-items-center py-4">
          <div class="col-lg-6 col-7">
            ...
            <div class="col-lg-7 col-md-10">
                <h1 class="display-2 text-white">Defenders</h1>
                <p class="text-white mt-0 mb-5">on this page you can add, change, and delete data in the table </p>
                <a href="{{ route('dashboarddefender.create')}}" class="btn btn-success">Tambah Data Defender</a>
              </div>
                ...
                <div class="col">
                    <div class="card bg-default shadow">
                        <div class="card-header bg-transparent border-0">
                            <h3 class="text-white mb-0">Table Defenders</h3>
                        </div>
                    ...
                    <th scope="col" class="text-white">Tackles</th>
                    <th scope="col" class="text-white">Interceptions</th>
                    ...
                    <tr>
                        ...
                        <div class="media align-items-center">
                            ...
                            <a href="#" class="avatar rounded-circle">
                              <img src="{{ asset($df->gambar) }}" height="auto" width="100" alt="">
                            </a>
                        </td>
                      ...
                      <td class="text-center">
                        ...
                        <a href="{{ route('dashboarddefender.edit',$df->id) }}" class="btn btn-sm btn-success"><i class="fas fa-fw fa-edit"></i>Edit</a>
                                <form action="{{ route('dashboarddefender.destroy',$df->id) }}" method="post" class="d-inline">
                                    @method('delete')
                                    @csrf
