        ...
        <div class="row align-items-center py-4">
          <div class="col-lg-6 col-7">
            ...
            <div class="col-lg-7 col-md-10">
                <h1 class="display-2 text-white">Add Defender</h1>
    ...
    <div class="row">
      <div class="col">
        <div class="card bg-default shadow">
            ...
            <div class="card-body">
                <form method="POST" action="{{route('dashboarddefender.store')}}" enctype="multipart/form-data">
                    @csrf
                  <h6 class="heading-small text-muted mb-4">User information</h6>
                  <button class="btn btn-primary mb-3" type="submit"><i class="fas fa-fw fa-user-plus"></i>Tambah Defender</button>
                  <div class="pl-lg-4">
                    <div class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="row">
                          <div class="col-lg-6">
                            <div class="form-group">
                              ...
                              <input type="text" id="tackles" name="tackles" class="form-control form-control-alternative" placeholder="Jumalah Tackles" value="{{ old('tackles')}}">
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group">
                              <label class="form-control-label" for="interceptions">Interceptions</label>
                              <input type="text" id="interceptions" name="interceptions" class="form-control form-control-alternative" placeholder="Jumlah Interceptions" value="{{ old('Interceptions')}}">
                            </div>
                          </div>
                        </div>
                      </div>
