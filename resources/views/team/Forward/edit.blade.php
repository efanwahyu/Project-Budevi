        ...
        <div class="row align-items-center py-4">
          <div class="col-lg-6 col-7">
            ...
            <div class="col-lg-7 col-md-10">
                <h1 class="display-2 text-white">Edit Forward</h1>
        ...
        <div class="card bg-default shadow">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('dashboardplayer.update',$player->id) }}" enctype="multipart/form-data">
                  ...
                  <button class="btn btn-primary mb-3" type="submit"><i class="fas fa-fw fa-user-plus"></i> Update Forward</button>
                  <div class="pl-lg-4">
                    <div class="row">
                        <div class="col-lg-6">
